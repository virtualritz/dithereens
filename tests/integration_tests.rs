...
fn test_different_methods() {
    ...
    let hash_result =
        dither_with_method(value, 0.0, 255.0, 0.5, 0, &hash_method);
    let r2_result = dither_with_method(value, 0.0, 255.0, 0.5, 0, &r2_method);
    let golden_result =
        dither_with_method(value, 0.0, 255.0, 0.5, 0, &golden_method);
...
fn test_method_consistency() {
    ...
    let hash_result =
        dither_with_method(value, 0.0, 255.0, 0.5, 10, &hash_method);
...
fn test_slice_with_methods() {
    ...
    simple_dither_slice_with_method(&mut values1, 255.0, &hash_method);
    simple_dither_slice_with_method(&mut values2, 255.0, &r2_method);
